...
function TechCard(props) {
    ...
    return (
        <div className="w-fit p-3">
            <div className={`rounded-full h-[4rem] w-[4rem] md:h-[6rem] md:w-[6rem] overflow-hidden border-4  md:border-[6px] ${colors[props.index % colors.length]} `}>
...
// I thought maybe if i first load the colors statically, then it might work dynamically...but it didnt work
